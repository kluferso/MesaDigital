...
export const INSTRUMENTS = [
  { id: 'guitar', label: 'Guitarra', icon: GuitarIcon },
  { id: 'bass', label: 'Baixo', icon: BassIcon },
  { id: 'piano', label: 'Teclado', icon: PianoIcon },
  { id: 'drums', label: 'Bateria', icon: DrumIcon },
  { id: 'violin', label: 'Violino', icon: ViolinIcon },
  { id: 'vocals', label: 'Voz', icon: VocalIcon },
  { id: 'saxophone', label: 'Saxofone', icon: SaxophoneIcon },
  { id: 'trumpet', label: 'Trompete', icon: TrumpetIcon },
  { id: 'other', label: 'Outro', icon: OtherInstrumentIcon }
];

export const getInstrumentIcon = (instrumentId) => {
  const instrument = INSTRUMENTS.find(i => i.id === instrumentId);
  return instrument ? instrument.icon : OtherInstrumentIcon;
};
