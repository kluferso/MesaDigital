              ...
              <Grid item xs={12}>
                <FormControlLabel
                  control={
                    <Switch
                      checked={musicMode}
                      onChange={(e) => toggleMusicMode(e.target.checked)}
                      color="secondary"
                    />
                  }
                  label={
                    <Box>
                      <Typography variant="body1" sx={{ fontWeight: 'bold' }}>
                        Modo Música (Alta Fidelidade)
                      </Typography>
                    </Box>
                  }
                />
                <Typography variant="body2" color="text.secondary" sx={{ ml: 4 }}>
                  Ativa áudio estéreo de alta qualidade, desativando cancelamento de eco e ruído. Ideal para instrumentos. Use fones de ouvido para evitar eco.
                </Typography>
              </Grid>
            </Grid>
          </Paper>

          <Paper variant="outlined" sx={{ p: 3, mb: 3, opacity: musicMode ? 0.5 : 1, pointerEvents: musicMode ? 'none' : 'auto' }}>
            <Typography variant="subtitle1" gutterBottom sx={{ fontWeight: 'medium' }}>
              {t('settings.audio.processing')} {musicMode && '(Desativado no Modo Música)'}
            </Typography>
