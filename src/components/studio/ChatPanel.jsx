 ...
 */
const ChatPanel = ({ roomId: propRoomId, socket: propSocket, onNewMessage, chatEndRef }) => {
  ...
  // Obter socket e roomId do contexto se não forem passados como props
  const { socket: contextSocket } = useSocket();
  const params = useParams();

  // Usar props ou valores do contexto/router
