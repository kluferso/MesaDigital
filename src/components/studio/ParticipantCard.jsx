...
const ParticipantCard = ({
    ...
    return (
      ...
      >
        ...
        <Box sx={{ display: 'flex', gap: 0.5 }}>
          ...
          <VUMeter level={audioLevel} status={audioStatus} height={20} width={4} orientation="horizontal" />
  ...
  return (
    ...
    >
      ...
      {/* VU Meter Vertical */}
      <Box sx={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', zIndex: 2 }}>
        <VUMeter level={audioLevel} status={audioStatus} height={80} width={6} />
      </Box>
