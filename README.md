...
- **Virtual Stage**: Spatial audio positioning
- **Video Grid**: Gallery view of all participants
- **Sheet Music Sharing**: Upload and view PDF scores in real-time
- **Session Recording**: Record and download rehearsals
- **Metronome**: Synchronized shared metronome
